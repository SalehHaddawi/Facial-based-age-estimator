...
Button(middleframe, text='Load Image', fg="#801E3A", bg="white", command=get_image, width=15).pack()
Button(middleframe, text='Load Video', fg='#801E3A', bg="white", command=get_video, width=15).pack()
Button(middleframe, text='Web Cam', fg='#801E3A', bg="white", command=open_cam, width=15).pack()
